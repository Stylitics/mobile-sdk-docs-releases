...
```gradle
     api('com.github.Stylitics:android-data-sdk-artifacts:1.5.0@aar') { transitive = true }
     api('com.github.Stylitics:android-ux-sdk-artifacts:1.5.0@aar') { transitive = true }
```
...
- **Gallery Bundle item view event** - UX SDK sends this event for all items in the Gallery Product list that are viewed by the user.
- **Gallery Bundle click event** - When user clicks on `Shop this look` CTA in the Dynamic Gallery Widget, UX SDK invokes this event.
- **Gallery Bundle item click event** - When user clicks on any Gallery Bundle item in the Product list view, UX SDK invokes this event.
...
**For Dynamic Gallery Product List**:
