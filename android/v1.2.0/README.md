...
* To clear data when Activity/Fragment is destroyed call it in view model like below:
...
- Data SDK version used in the Sample Integrator App : *_**V1.2.0**_*
- Data SDK version used in the UX SDK : *_**V1.2.0**_*
- UX SDK version used in the Sample Integrator App : *_**V1.2.0**_*
