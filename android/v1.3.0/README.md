...
```gradle
     api('com.github.Stylitics:android-data-sdk-artifacts:1.3.0@aar') { transitive = true }
     api('com.github.Stylitics:android-ux-sdk-artifacts:1.3.0@aar') { transitive = true }
```
