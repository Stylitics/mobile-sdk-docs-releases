...
When the "store" is ready, the user is shown a grid of products which have outfit coverage (per the API server of the selected Environment).  Tapping on one brings the user to a sample PDP screen.
...
3. In Sample Integrator App project, create new directory in project level named libs.
...
Steps to import the Stylitics UX SDK into the Sample Integrator App:
 ...
 2. Import .AAR file to the Integrator App
 3. In Sample Integrator App project, copy and paste downloaded .AAR file to the libs folder.
...
- Data SDK version used in the Sample Integrator App : *_**V1.0.11**_*
- Data SDK version used in the UX SDK : *_**V1.0.11**_*
- UX SDK version used in the Sample Integrator App : *_**V1.0.11**_*
