...
Below screenshot shows the Dynamic Gallery Product List in custom Light and Dark mode.

**Screenshots :**

![Image5](Screenshots/custom_light_and_dark_mode_support_for_dynamic_gallery_product_list.png)
